            ...
            try {
                ...
                if (this.masStore.mas.magnetic.coil.functionalDescription[this.windingIndex].wire != "" &&
                    ...
                    if ((newType == "litz" && !this.isAnyLitzLoaded()) ||
                        ...
                        this.taskQueueStore.calculateEquivalentWire(this.masStore.mas.magnetic.coil.functionalDescription[this.windingIndex].wire, newType, effectiveFrequency).then((wire) => {
