...
<template>
    <div class="container">
        <div class="row">
            <div v-if="severalWires" :class="allowAdvise? 'col-4' : 'col-0'" class="container m-0 p-0">
                <button
                    :style="$styleStore.magneticBuilder.adviseButton"
                    v-if="allowAdvise"
                    :disabled="!enableAdvise"
                    :data-cy="dataTestLabel + 'Wire-Advise-button'"
                    class="btn btn-primary mx-auto d-block mt-1 row"
                    style="width:100%" @click="$emit('adviseWire')"
                >
                    {{'Advise wire'}}
                </button>
                <button
            ...
            <button
                ...
                :disabled="!enableAdvise"
                :data-cy="dataTestLabel + 'Wire-Advise-button'"
                class="btn btn-primary mx-auto d-block mt-1 col-4"
            ...
            <button 
                ...
                class="btn btn-success mx-auto d-block mt-1"
            ...
            <button
                ...
                :class="allowAdvise? 'col-4' : 'col-6'"
                class="btn btn-secondary mx-auto d-block mt-1"
                @click="$emit('loadCore')"
            >
                {{'Load wire from library'}}
            </button>
        </div>
    </div>
</template>
